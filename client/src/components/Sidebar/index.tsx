      ...
      },
      {
        icon: (
          ...
          >
            ...
            />
            <path
              d="M15.75 7.5H8.25C7.00736 7.5 6 8.50736 6 9.75V11.25C6 11.6642 6.33579 12 6.75 12H17.25C17.6642 12 18 11.6642 18 11.25V9.75C18 8.50736 16.9926 7.5 15.75 7.5Z"
              fill=""
            />
            <path
              d="M18.75 13.5H5.25C4.00736 13.5 3 14.5074 3 15.75V17.25C3 17.6642 3.33579 18 3.75 18H20.25C20.6642 18 21 17.6642 21 17.25V15.75C21 14.5074 19.9926 13.5 18.75 13.5Z"
              fill=""
            />
          </svg>
        ),
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <ClickOutside onClick={() => setSidebarOpen(false)}>
      <aside
        className={`absolute left-0 top-0 z-9999 flex h-screen flex-col overflow-y-hidden overflow-x-hidden bg-white dark:bg-gray-dark lg:static lg:translate-x-0 ${
          sidebarOpen ? "translate-x-0" : "-translate-x-full"
        } ${isCollapsed ? "w-30" : "w-70"} transition-all duration-300 ease-in-out`}
      >
        {/* <!-- SIDEBAR HEADER --> */}
        ...
        <div className="flex flex-col overflow-y-hidden overflow-x-hidden duration-300 ease-linear">
          {/* <!-- Sidebar Menu --> */}
          <nav className={`mt-5 py-4 px-4 lg:mt-9 lg:px-6 ${isCollapsed ? 'px-2' : ''}`}>
