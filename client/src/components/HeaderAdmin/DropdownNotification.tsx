...
const notificationList = [
  {
    ...
    title: "Tito Linares ha reservado!",
    subTitle: "Cancha de 5",
  },
  {
    image: "/images/user/user-02.png",
    title: "Nuevo mensaje received",
  ...
  },
  {
    ...
    title: "Jolly reservo una cancha",
    subTitle: "Revisa tus ganancias",
  },
  {
    image: "/images/user/user-27.png",
    title: "Roman se unió al equipo!",
...
const DropdownNotification = () => {
  ...
  return (
    <ClickOutside onClick={() => setDropdownOpen(false)} className="relative hidden sm:block z-99999">
      <li>
        <Link
          onClick={() => {
            setNotifying(false);
